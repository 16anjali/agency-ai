...
const ContactUs = () => {
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "fd283c04-6ca6-4fe6-afa8-c957a20c5e3a");
try{
    ...
    <div id='contact-us' className='flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
      ...
      <form onSubmit={onSubmit} className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full'>
            ...
            <div className='sm:col-span-2'>
                ...
                <textarea rows={8} name="message" placeholder='Enter your message' className='w-full p-3 text-sm outline-none rounded-lg border 
            ...
            transition-all' type='submit'>Submit <img src={assets.arrow_icon} alt="" className='w-4'/></button>
      </form>
    </div>
  )
}
